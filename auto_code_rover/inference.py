...
from auto_code_rover import globals
from auto_code_rover.api.manage import ProjectApiManager
from auto_code_rover.data_structures import FunctionCallIntent, MessageThread
from auto_code_rover.log import (
    log_and_cprint,
    log_and_print,
    print_acr,
    print_banner,
...
from auto_code_rover.model import common, ollama
from auto_code_rover.search.search_manage import SearchManager
from auto_code_rover.utils import parse_function_invocation
...
def start_conversation_round_stratified(
    ...
    for round_no in range(start_round_no, globals.conv_round_limit + 1):
        ...
        for api_call in json_api_calls:
            ...
            extracted_code[api_call] = tool_output
        ...
        logger.info("Too maciting patch anyway.")
