...
from auto_code_rover.data_structures import FunctionCallIntent
from auto_code_rover.log import log_and_print
from auto_code_rover.model import common
from auto_code_rover.model.common import Model
...
class Gpt4_o1_mini(OpenaiModel):
    def __init__(self):
        super().__init__("o1-mini-2024-09-12", 0.000003, 0.000012)
        self.note = "Not turbo."

class Gpt4_o1_preview(OpenaiModel):
    def __init__(self):
        super().__init__("o1-preview-2024-09-12", 0.000015, 0.000060)
        self.note = "Not turbo."
