from auto_code_rover.model import bedrock, claude, common, gemini, gpt, gptlitellm, groq, ollama
...
def register_all_models() -> None:
    ...
    common.register_model(gpt.Gpt4_o1_mini)
    common.register_model(gpt.Gpt4_o1_preview)
